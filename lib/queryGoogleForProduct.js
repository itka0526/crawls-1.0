...
export default async function queryGoogleForProduct(product_model_number) {
    const encoded = encodeURIComponent(product_model_number);
    const search = `https://www.google.mn/search?q=site%3A.mn+${encoded}&ei=lernYor6Caju2roPp_y--AY&ved=0ahUKEwjKmMqZ9KX5AhUot1YBHSe-D28Q4dUDCA0&uact=5&oq=site%3A.mn+huvtsas&gs_lcp=Cgdnd3Mtd2l6EANKBAhBGAFKBAhGGABQrwZY1QdgzgloAnAAeACAAXmIAdwBkgEDMS4xmAEAoAEBwAEB&sclient=gws-wiz`;
    ...
    function recursive(element) {
        if (
            ...
            try {
                ...
                // console.error(link, "invalid link\r");
            }
        }
